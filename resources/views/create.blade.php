...
<div class="form-container">
    ...
    <form id="bookForm" action="{{ route('create.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <!-- Kategori STEM -->
        <div class="glass-input">
            <input type="text" id="category_stem" name="category_stem" required placeholder="Kategori STEM" />
            <label for="category_stem">Kategori STEM</label>
        </div>

        <!-- Kategori Resource -->
        <div class="glass-input">
            <input type="text" id="category_resource" name="category_resource" required placeholder="Kategori Resource" />
        ...
        <!-- Deskripsi -->
        <div class="glass-input">
            <textarea id="description" name="description" rows="4" placeholder="Deskripsi"></textarea>
        ...
        <div class="glass-input">
            ...
            <div class="drop-zone" id="drop-zone">
                <span id="file-text">Klik atau drag & drop file di sini</span>
        ...
        <div class="d-flex justify-content-end mt-3">
            ...
            <button type="submit" class="btn-glass">Simpan Buku</button>
        </div>
    </form>
</div>
